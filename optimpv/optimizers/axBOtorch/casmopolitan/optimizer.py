...
class Optimizer:
    ...
    def __init__(self, config,
        ...
        n_init : int | None, optional
            Number of initialization points to use, is not used when initial seeding is provided.
        wrap_discrete : bool, optional
            Whether discrete samples should be projected back to a valid encoding.
        ...
        **kwargs
            Additional options forwarded to the CASMOPOLITAN optimizer.
        """
    ...
    def restart(self):
        """Reset or re-seed the local optimizer after TR collapse."""
    ...
    def suggest(self, n_suggestions=1):
        """Generate the next batch of suggested points.
        ...
        -------
        numpy.ndarray
            Suggested points in ordinal categorical representation.
        """
